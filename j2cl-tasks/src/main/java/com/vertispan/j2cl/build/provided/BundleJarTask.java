...
public class BundleJarTask extends TaskFactory {
    ...
    public Task resolve(Project project, Config config, BuildService buildService) {
        ...
        Input jszip = input(project, JSZIP_BUNDLE_OUTPUT_TYPE, buildService);
        ...
        return new FinalOutputTask() {
            ...
            public void finish(TaskContext taskContext) throws IOException {
                ...
                if (Files.isDirectory(initialScriptFile.getParentFile().toPath())) {
                    FileUtils.deleteDirectory(initialScriptFile.getParentFile());
                }
