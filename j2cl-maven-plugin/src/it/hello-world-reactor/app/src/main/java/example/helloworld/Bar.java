...
public class Bar {
    ...
    public String getMessage() {
        new Foo1().nativeMethod();
        return new Foo1().getMessage();
    }
    ...
    public static class InnerBar {
        ...
        public String getMessage() {
            return "hello from InnerBar";
        }

        @JsType
        public static class InnerInnerBar extends Base2 {
            public InnerInnerBar() {
                super();
            }
            public String getMessage() {
                return "hello from InnerInnerBar";
            }
        }
    }
